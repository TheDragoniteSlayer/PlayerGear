...
// Global pollen multiplier: change this to adjust the overall pollen boost (currently 300x)
window.POLLEN_MULT = 300

// Merge into any existing playerGear instead of replacing it outright.
// This makes the object safe to reference from other scripts that may run earlier.
    ...
    mask:{
        ...
        helmet:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=1.15*window.POLLEN_MULT
                stats.whitePollen*=1.15*window.POLLEN_MULT
                stats.redPollen*=1.15*window.POLLEN_MULT
                stats.defense+=0.1
        ...
        propellerHat:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=1.2*window.POLLEN_MULT
                stats.whitePollen*=1.2*window.POLLEN_MULT
                stats.redPollen*=1.2*window.POLLEN_MULT
                stats.jumpPower*=1.1
        ...
        beekeeperMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.pollenFromBees*=1.22*window.POLLEN_MULT
                stats.defense+=0.25
        ...
        honeyMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=1.4*window.POLLEN_MULT
                stats.whitePollen*=1.4*window.POLLEN_MULT
                stats.redPollen*=1.4*window.POLLEN_MULT
                stats.pollenFromBees*=1.35*window.POLLEN_MULT
                stats.defense+=0.3
        ...
        fireMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.capacityMultiplier*=1.75
                stats.redPollen*=1.6*window.POLLEN_MULT
        ...
        gummyMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=1.35*window.POLLEN_MULT
                stats.whitePollen*=1.35*window.POLLEN_MULT
                stats.redPollen*=1.35*window.POLLEN_MULT
        ...
        diamondMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=1.5*window.POLLEN_MULT
                stats.bluePollen*=1.35*window.POLLEN_MULT
                stats.whitePollen*=1.35*window.POLLEN_MULT
                stats.redPollen*=1.35*window.POLLEN_MULT
                stats.convertRate*=2
        ...
        demonMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.redPollen*=1.75*window.POLLEN_MULT
                stats.beeAttack*=1.25
                stats.instantFlameConversion=window.applyPercentage(stats.instantFlameConversion,0.5)
                stats.flamePollen*=2*window.POLLEN_MULT
                stats.redBeeAbilityRate*=1.2
                stats.blueBeeAbilityRate*=1.2
                stats.whiteBeeAbilityRate*=1.2
                stats.defense+=0.35
    ...
    belt:{
        ...
        honeycombBelt:{
            ...
            applyStats:function(stats,player){
                ...
                stats.honeyFromTokens*=1.5
                stats.whiteBeeAttack = (stats.whiteBeeAttack || 0) + 1
                stats.whiteBombPollen*=1.3*window.POLLEN_MULT
        ...
        petalBelt:{
            ...
            applyStats:function(stats,player){
                ...
                stats.whiteBombPollen*=1.5*window.POLLEN_MULT
    ...
    coconutCanister: {
        ...
        mondoBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.pollenFromBees*=1.25*window.POLLEN_MULT
                stats.beeSpeed*=1.2
            },
    ...
    leftGuard:{
        ...
        bomberGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.whiteBombPollen*=1.15*window.POLLEN_MULT
                stats.redBombPollen*=1.15*window.POLLEN_MULT
                stats.blueBombPollen*=1.15*window.POLLEN_MULT
            },
        ...
        rileyGuard:{
            ...
            mesh:function(box,cylinder,sphere){ ... } // file continues unchanged
    }
}
})()
